...
<div class="max-w-lg mx-auto mt-10 bg-white p-6 rounded-xl shadow-lg border border-gray-200">
    ...
    <div class="space-y-2 mb-5">
        ...
        <p><span class="font-semibold text-gray-700">Harga:</span> Rp{{ number_format($order->product->price, 0, ',', '.') }}</p>
        <p><span class="font-semibold text-gray-700">Metode Pembayaran:</span> {{ strtoupper(str_replace('_', ' ', $order->payment_method)) }}</p>
    </div>
