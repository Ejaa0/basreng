...
<div class="p-6 space-y-6 bg-gray-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        <!-- Total Produk -->
        <div class="bg-white shadow-xl rounded-xl p-6 flex items-center space-x-4 hover:scale-105 transform transition duration-300">
    ...
    <div class="mt-6 bg-blue-50 text-blue-700 p-4 rounded-xl shadow">
        <p class="font-semibold text-gray-800">Tips:</p>
        <p class="text-sm md:text-base mt-1">
            Pastikan produk terbaru selalu diperbarui agar pelanggan tertarik dan pesanan meningkat!
        </p>
    </div>
